        ...
        return (
            <div className='systemWrap'>
                ...
                <div className='systemMsg'>
                    <div>
                        <label>姓名</label><input type='text' defaultValue={data.name}/>
                    </div>
                    <div>
                        <label>手机号</label><input type='text' defaultValue={data.telenum}/>
                    </div>
                    <div>
                        <label>密码</label><input type='text' defaultValue={data.password}/>
                    </div>
                </div>
                <h3>权限</h3>
